...
----
$ git clone git@github.com:rmaddali/anotherone
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/rmaddali/anotherone/edit/master/src/main/resources/webroot/index.html[`src/main/resources/webroot/index.html`]).
